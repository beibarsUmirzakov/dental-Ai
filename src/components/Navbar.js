...
function Navbar() {
  ...
  return (
      <>
        {/* Боковое меню для 1024 и больше */}
        <div className="navbar-desktop">
          ...
          <nav>
            ...
            <Link className={isActive('/ai-analysis') ? 'active nav-content' : 'nav-content'} to="/ai-analysis">Анализ ИИ</Link>
